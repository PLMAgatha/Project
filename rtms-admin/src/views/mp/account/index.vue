...
<!--      </el-table-column>-->
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template v-slot="scope">
          ...
          <el-button size="small" type="text" icon="el-icon-refresh" @click="handleGenerateQrCode(scope.row)"
                     v-hasPermi="['mp:account:qr-code']">生成二维码
          </el-button>
          <el-button size="small" type="text" icon="el-icon-share" @click="handleCleanQuota(scope.row)"

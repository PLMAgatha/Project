      ...
      <el-table-column label="内容" prop="content">
        <template v-slot="scope">
          ...
          <div v-else-if="scope.row.type === 'event' && scope.row.event === 'CLICK'">
            <el-tag size="small">点击菜单</el-tag>【{{ scope.row.eventKey }}】
          </div>
          <div v-else-if="scope.row.type === 'event' && scope.row.event === 'VIEW'">
            <el-tag size="small">点击菜单链接</el-tag>【{{ scope.row.eventKey }}】
          </div>
          <div v-else-if="scope.row.type === 'event' && scope.row.event === 'scancode_waitmsg'">
            <el-tag size="small">扫码结果</el-tag>【{{ scope.row.eventKey }}】
          </div>
          ...
          <div v-else>
            <el-tag type="danger"size="small">未知消息类型</el-tag>
          </div>
        </template>
      </el-table-column>
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template v-slot="scope">
          <el-button size="small" type="text" icon="el-icon-edit" @click="handleSend(scope.row)"

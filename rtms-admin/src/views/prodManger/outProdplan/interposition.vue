...
import {insertone, getproductnumber, getoneproductnumber} from "@/api/prodManger/outProdplan"
    ...
    submitForm: function () {
      this.$refs["form"].validate(valid => {
        if (valid) {
          ...
          // this.form.prodLineName = this.$props.prodLineName;
          let obj = {};
          obj.outCreateReqVO = this.form;
          obj.id = this.$props.id;
          obj.sort = this.$props.sort;
          obj.outCreateReqVO.productCode = this.onedata.imageCode

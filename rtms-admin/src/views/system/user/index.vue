    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList">
          <el-table-column label="用户编号" min-width="100" align="center" key="id" prop="id"
                           v-if="columns[0].visible"/>
          <el-table-column label="用户名称" width="90" align="center" key="username" prop="username"
                           v-if="columns[1].visible"
                           :show-overflow-tooltip="true"/>
          <el-table-column label="用户昵称" width="90" align="center" key="nickname" prop="nickname"
                           v-if="columns[2].visible"
                           :show-overflow-tooltip="true"/>
          <el-table-column label="部门" width="90" align="center" key="deptName" prop="dept.name"
                           v-if="columns[3].visible"
                           :show-overflow-tooltip="true"/>
          <el-table-column width="120" label="手机号码" align="center" key="mobile" prop="mobile"
                           v-if="columns[4].visible"/>
          <el-table-column label="状态" width="180" key="status" v-if="columns[5].visible" align="center">
            <template v-slot="scope">
              <el-switch v-model="scope.row.status" :active-value="0" :inactive-value="1"
                         @change="handleStatusChange(scope.row)"/>
            </template>
          </el-table-column>
          <el-table-column label="创建时间" width="180" align="center" prop="createTime" v-if="columns[6].visible">
            <template v-slot="scope">
          ...
          <el-table-column label="操作" width="210" align="center" class-name="small-padding fixed-width">
            <template v-slot="scope">
              <el-button size="small" type="text" icon="el-icon-edit-outline" @click="handleUpdate(scope.row)"
              ...
              <el-dropdown @command="(command) => handleCommand(command, scope.$index, scope.row)"
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item command="handleDelete" v-if="scope.row.id !== 1" size="small" type="text"
                                    icon="el-icon-delete"
                                    v-hasPermi="['system:user:delete']">删除
                  </el-dropdown-item>
                  <el-dropdown-item command="handleResetPwd" size="small" type="text" icon="el-icon-key"
                                    v-hasPermi="['system:user:update-password']">重置密码
                  </el-dropdown-item>
                  <el-dropdown-item command="handleRole" size="small" type="text" icon="el-icon-circle-check"

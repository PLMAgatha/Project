<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus"size="small" @click="handleUpdateList">标记已读</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus"size="small" @click="handleUpdateAll">全部已读</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" ref="tables" :data="list">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="150">
        <template v-slot="scope">
          <el-button v-show="!scope.row.readStatus"size="small" type="text" icon="el-icon-check" @click="handleUpdateSingle(scope.row)">已读</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->

<template>
  <div class="app-container">
    ...
    <el-table v-if="refreshTable" v-loading="loading" :data="deptList" row-key="id" :default-expand-all="isExpandAll"
      ...
      <el-table-column prop="name" label="部门名称"  align="center" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="updaterNickName" label="负责人"  align="center" :show-overflow-tooltip="true"/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template v-slot="scope">
          ...
          <el-button v-if="scope.row.parentId !== 0" size="small" type="text" icon="el-icon-delete"

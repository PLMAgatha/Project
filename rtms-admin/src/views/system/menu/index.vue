  ...
  <div class="app-container">
    ...
    <div class="add-btn">
      <el-button type="primary" plain icon="el-icon-plus" size="small" @click="handleAdd"
                 v-hasPermi="['system:menu:create']">新增
      </el-button>
      <el-button type="info" plain icon="el-icon-sort" size="small" @click="toggleExpandAll">展开/折叠</el-button>
    ...
    <el-table v-if="refreshTable" v-loading="loading" :data="menuList" row-key="id" :default-expand-all="isExpandAll"
      ...
      <el-table-column prop="name" label="菜单名称" min-width="90" align="center" :show-overflow-tooltip="true"
      ...
      <el-table-column prop="permission" label="权限标识" min-width="90" align="center" :show-overflow-tooltip="true"/>
      <el-table-column prop="component" label="组件路径" min-width="90" align="center" :show-overflow-tooltip="true"/>
      <el-table-column prop="componentName" label="组件名称" min-width="90" align="center"

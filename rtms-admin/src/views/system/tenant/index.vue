<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      <el-table-column label="租户编号" min-width="90" align="center" prop="id"/>
      <el-table-column label="租户名" min-width="90" align="center" prop="name"/>
      <el-table-column label="租户套餐" min-width="90" align="center" prop="packageId">
        <template v-slot="scope">
          <el-tag v-if="scope.row.packageId === 0" type="danger">系统租户</el-tag>
          <el-tag v-else> {{ getPackageName(scope.row.packageId) }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="联系人" width="90" align="center" prop="contactName"/>
      <el-table-column label="联系手机" width="90" align="center" prop="contactMobile"/>
      <el-table-column label="账号额度" min-width="90" align="center" prop="accountCount">
        <template v-slot="scope">
          <el-tag> {{ scope.row.accountCount }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="过期时间" width="180" align="center" prop="expireTime">
        <template v-slot="scope">
          <span>{{ parseTime(scope.row.expireTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column label="绑定域名" width="180" align="center" prop="domain"/>
      <el-table-column label="租户状态" width="120" align="center" prop="status">
        <template v-slot="scope">

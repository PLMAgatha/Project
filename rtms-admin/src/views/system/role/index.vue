<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roleList">
      <el-table-column label="角色编号" min-width="90" align="center" prop="id"/>
      <el-table-column label="角色名称" min-width="90" align="center" prop="name" :show-overflow-tooltip="true"/>
      <el-table-column label="角色标识" min-width="90" align="center" prop="code" :show-overflow-tooltip="true"/>
      <el-table-column label="角色类型" min-width="90" align="center" prop="type">
        <template v-slot="scope">
          <dict-tag :type="DICT_TYPE.SYSTEM_ROLE_TYPE" :value="scope.row.type"/>
        </template>
      </el-table-column>
      <el-table-column label="显示顺序" width="120" align="center" prop="sort"/>
      ...
      <el-table-column label="操作" width="300" align="center" class-name="small-padding fixed-width">
        <template v-slot="scope">
          ...
          <el-button size="small" type="text" icon="el-icon-circle-check" @click="handleMenu(scope.row)"
                     v-hasPermi="['system:permission:assign-role-menu']">菜单权限
          </el-button>
          <el-button size="small" type="text" icon="el-icon-circle-check" @click="handleDataScope(scope.row)"
                     v-hasPermi="['system:permission:assign-role-data-scope']">数据权限
          </el-button>
    ...
    <el-dialog title="分配数据权限" :visible.sync="openDataScope" width="500px" append-to-body>
      <el-form :model="form" label-width="80px">
        ...
        <el-form-item label="数据权限" v-show="form.dataScope === SysDataScopeEnum.DEPT_CUSTOM">
          <el-checkbox :checked="!form.deptCheckStrictly" @change="handleCheckedTreeConnect($event, 'dept')">
            父子联动(选中父节点，自动选择子节点)
          </el-checkbox>

    ...
    <div class="content">
      ...
      <div class="field">
        ...
        <h2 class="mobile-title">
          <h3 class="title">xFactory智慧工厂平台</h3>
        </h2>
        <!-- 表单 -->
        <div class="form-cont">
          <el-tabs class="form" v-model="loginForm.loginType" style=" float:none;text-align: center">
            <el-tab-pane label="登录" name="uname" style="width: 100%">
            </el-tab-pane>
          </el-tabs>
          <div>
            <el-form ref="loginForm" :model="loginForm" :rules="LoginRules" class="login-form">
              ...
              <div v-if="loginForm.loginType === 'uname'">
                ...
                <el-checkbox v-model="loginForm.rememberMe" style="margin:0 0 25px 0;" class="remember">记住密码
                </el-checkbox>
              </div>
              <div>
              </div>
              ...
              <el-form-item style="width:100%;">
                <el-button :loading="loading" size="medium" type="primary" style="width:100%;"
                  ...
                  <span v-if="!loading" class="register">登 录</span>
                  <span v-else class="register">登 录 中...</span>
                </el-button>
              </el-form-item>
            </el-form>
          </div>

  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="操作" align="center" fixed="right" class-name="small-padding fixed-width">
        <template v-slot="scope">
          <el-button size="small" type="text" icon="el-icon-search" @click="handleQueryDetails(scope.row)"
    ...
    <el-dialog title="退款订单详情" :visible.sync="open" width="700px" append-to-body>
      ...
      <el-descriptions :column="2" label-class-name="desc-label">
        ...
        <el-descriptions-item label="退款金额"size="small">
          <el-tag class="tag-purple"size="small">{{ parseFloat(refundDetail.refundAmount / 100).toFixed(2) }}</el-tag>
        </el-descriptions-item>

    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template v-slot="scope">
          ...
          <el-button size="small" type="text" icon="el-icon-delete" @click="handleClose(scope.row)"
                     v-if="scope.row.status !== PromotionActivityStatusEnum.CLOSE.type &&
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="商品选择">
          ...
          <el-table v-loading="loading" :data="form.products">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
              <template v-slot="scope">
                <el-button size="small" type="text" icon="el-icon-delete" @click="removeFormSku(scope.row.skuId)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-form-item>

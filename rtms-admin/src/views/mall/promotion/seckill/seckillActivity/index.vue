    ...
    <div class="app-container">
      <doc-alert title="功能开启" url="" />
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="primary" plain icon="el-icon-menu"size="small" @click="openSeckillTime"
        ...
        <el-table v-loading="loading" :data="list">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template v-slot="scope">
                    ...
                    <el-button size="small" type="text" icon="el-icon-close" @click="handleClose(scope.row)"
        ...
        <el-dialog :title="title" :visible.sync="open" width="1200px" v-dialogDrag append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="商品选择">
                    ...
                    <el-row>
                        <el-button type="primary"size="small" @click="batchEditProduct('limitBuyCount')">限购</el-button>
                        <el-button type="primary"size="small" @click="batchEditProduct('seckillPrice')">秒杀价</el-button>
                        <el-button type="primary"size="small" @click="batchEditProduct('seckillStock')">秒杀库存</el-button>
                    </el-row>
                    <el-table v-loading="loading" ref="productsTable" :data="form.products">
                        ...
                        <el-table-column label="限购(0为不限购)" align="center" width="150">
                            <template v-slot="scope">
                                <el-input-number v-model="scope.row.limitBuyCount"size="small" :min="0" :max="10000">
                                </el-input-number>
                            </template>
                        </el-table-column>
                        <el-table-column label="秒杀价(元)" align="center" width="150">
                            <template v-slot="scope">
                                <el-input-number v-model="scope.row.seckillPrice"size="small" :precision="2" :min="0"
                                    :max="10000">
                                </el-input-number>
                            </template>
                        </el-table-column>
                        <el-table-column label="秒杀库存" align="center" width="150" prop="seckillStock">
                            <template v-slot="scope">
                                <el-input-number v-model="scope.row.seckillStock"size="small" :min="0" :max="10000">
                                </el-input-number>
                            </template>
                        </el-table-column>
                        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                            <template v-slot="scope">
                                <el-buttonsize="small" type="text" icon="el-icon-delete"

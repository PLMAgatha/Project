    ...
    <el-card class="box-card" v-loading="processInstanceLoading" v-for="(item, index) in runningTasks" :key="index">
      ...
      <el-col :span="16" :offset="6" >
        ...
        <div style="margin-left: 10%; margin-bottom: 20px; font-size: 14px;">
          <el-button  icon="el-icon-edit-outline" type="success"size="small" @click="handleAudit(item, true)">通过</el-button>
          <el-button  icon="el-icon-circle-close" type="danger"size="small" @click="handleAudit(item, false)">不通过</el-button>
          <el-button  icon="el-icon-edit-outline" type="primary"size="small" @click="handleUpdateAssignee(item)">转办</el-button>
          <el-button icon="el-icon-edit-outline" type="primary"size="small" @click="handleDelegate(item)">委派</el-button>
          <el-button icon="el-icon-refresh-left" type="warning"size="small" @click="handleBack(item)">退回</el-button>
        </div>
      </el-col>
    </el-card>
    <!-- 申请信息 -->

    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="操作" align="center" width="450" fixed="right">
        <template v-slot="scope">
          ...
          <el-button size="small" type="text" icon="el-icon-setting" @click="handleDesign(scope.row)"
            v-hasPermi="['bpm:model:update']">设计流程</el-button>
          <el-button size="small" type="text" icon="el-icon-s-custom" @click="handleAssignRule(scope.row)"
            v-hasPermi="['bpm:task-assign-rule:query']">分配规则</el-button>
          <el-button size="small" type="text" icon="el-icon-thumb" @click="handleDeploy(scope.row)"
            v-hasPermi="['bpm:model:deploy']">发布流程</el-button>
          <el-button size="small" type="text" icon="el-icon-ice-cream-round" @click="handleDefinitionList(scope.row)"
    ...
    <el-dialog title="导入流程" :visible.sync="upload.open" width="400px" append-to-body>
      <el-upload ref="upload" :limit="1" accept=".bpmn, .xml" :headers="upload.headers" :action="upload.url"
        ...
        <div class="el-upload__tip" slot="tip">
          <el-form ref="uploadForm" size="small" label-width="90px" :model="upload.form" :rules="upload.rules"

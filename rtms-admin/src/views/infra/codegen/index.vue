<template>
  <div class="app-container">
    ...
    <!-- 操作工作栏 -->
    <div class="add-btn">
      <el-button type="info" plain icon="el-icon-upload" size="small" @click="openImportTable"
    ...
    <el-table v-loading="loading" :data="tableList">
      ...
      <el-table-column label="操作" align="center" width="300px" class-name="small-padding fixed-width">
        <template v-slot="scope">
          ...
          <el-button type="text" size="small" icon="el-icon-edit-outline" @click="handleEditTable(scope.row)"

...
import editDialog from "@/views/BasicConfiguration/MaterialPreparation/editDialog.vue";
...
export default {
  ...
  methods: {
    ...
    handleEdit(row) {
      ...
      this.editTochannelData.formData.endStationId = String(this.editTochannelData.formData.endStationId)
    ...
    handleExcel() {
      if (this.multipleSelection.length == 0) {
        this.$message.warning('请选择要导出的备料图号配置')
      } else {
